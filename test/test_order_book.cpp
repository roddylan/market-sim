...
TEST_F(OrderBookTest, BuyExecution) {
  ...
  EXPECT_FLOAT_EQ((*book.get_buy_orders().begin())->get_price(), buy_1->get_price());
  auto top = **book.get_buy_orders().begin();
  ...
  EXPECT_EQ(book.get_sell_orders().size(), 5);
  EXPECT_FLOAT_EQ((*book.get_buy_orders().begin())->get_price(), buy_2->get_price());
  EXPECT_EQ((*book.get_buy_orders().begin())->get_volume(), 50);
  ...
  EXPECT_EQ(book.get_sell_orders().size(), 5);
  EXPECT_FLOAT_EQ((*book.get_buy_orders().begin())->get_price(), buy_4->get_price());
  EXPECT_EQ((*book.get_buy_orders().begin())->get_volume(), 50);
  EXPECT_EQ((*book.get_buy_orders().begin())->get_trader(), buy_4->get_trader());
  EXPECT_EQ((*book.get_buy_orders().begin())->get_time(), buy_4->get_time());
...
TEST_F(OrderBookTest, SellExecution) {
  EXPECT_EQ(book.get_buy_orders().size(), 5);
  EXPECT_EQ(book.get_sell_orders().size(), 5);
  
  EXPECT_FLOAT_EQ((*book.get_sell_orders().begin())->get_price(), sell_1->get_price());
  auto top = **book.get_sell_orders().begin();
  ...
  EXPECT_FLOAT_EQ((*book.get_sell_orders().begin())->get_price(), sell_2->get_price());
  EXPECT_EQ((*book.get_sell_orders().begin())->get_volume(), -50);
  EXPECT_FLOAT_EQ(price, (fair_price+1));
  ...
  EXPECT_FLOAT_EQ((*book.get_sell_orders().begin())->get_price(), sell_4->get_price());
  EXPECT_EQ((*book.get_sell_orders().begin())->get_volume(), -50);
  EXPECT_EQ((*book.get_sell_orders().begin())->get_trader(), sell_4->get_trader());
  EXPECT_EQ((*book.get_sell_orders().begin())->get_time(), sell_4->get_time());
  EXPECT_FLOAT_EQ(price, ((fair_price+1) + (fair_price+2)) / 2);
